...
def combine_and_save(
    ...
    for k in rpn_cls_keys:
        # fine-tuning된 RPN의 weight를 저장 , 두 weight를 모두 포함하는것
        novel_model[k.replace(".objectness", ".finetuned_objectness")] = novel_model[k]
        novel_model[k] = base_model[k] # base rpn weight
